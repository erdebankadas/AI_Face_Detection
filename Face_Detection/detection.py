...
class FaceRecognition:    
    ...
    def faceDetect(self, Entry1):
        ...
        # cam = cv2.VideoCapture('http://127.0.0.1:8000/', cv2.CAP_DSHOW)
        # cam.open(0, apiPreference = cv2.CAM_V4L2)
        # address = "http://127.0.0.1:8000/cam"
        # cam.open(address)
        ...
        while(True):
            ...
            for (x,y,w,h) in faces:
                ...
                # cv2.imread(r"C:\Users\khalid\Desktop\scolarship\1636898479537.jpg",cv2.COLOR_BGR2GRAY)
